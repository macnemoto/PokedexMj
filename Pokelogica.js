...
fetch('https://pokeapi.co/api/v2/pokemon/raichu/')
  ...
  .then(function(neko) {
    ...
    contenido.innerHTML= '<div class="col align-self-center"> <div class="card" style="width: 18rem;" > <img class="table table-dark" class="card-img-top" src='+neko.sprites.front_default+' alt=""Card image cap"">  <div  class="card-body"> <h5  class="card-title">Pokemon: '+neko.forms['0'].name+'</h5> <hr> <p> Habilidad 1:  '+neko.abilities['0'].ability.name+' <br> Habilidad 2:  '+neko.abilities['1'].ability.name+' </p>  </div> </div> </div>';
  }); 
